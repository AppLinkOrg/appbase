...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__forget_password__ = __webpack_require__(290);
 ...
 */
var ForgetPasswordPage = /** @class */ (function (_super) {
    __extends(ForgetPasswordPage, _super);
    function ForgetPasswordPage(navCtrl, modalCtrl, alertCtrl, statusBar, viewCtrl, toastCtrl, navParam, memberapi) {
    ...
    ForgetPasswordPage.prototype.onMyShow = function () {
    };
    ForgetPasswordPage.prototype.next = function () {
        var _this = this;
        ...
        this.memberapi.checkcanreg({ mobile: this.mobile }).then(function (ret) {
            if (ret.code == "1") {
                _this.modal("VerifyCodePage", { mobile: _this.mobile, type: "reset" }, function (ret) {
                    if (ret != undefined) {
                        if (ret.verifyed == "Y") {
                            _this.memberapi.resetpassword({ mobile: _this.mobile, password: _this.password }).then(function (ret) {
                                if (ret.code == "0") {
                                    _this.close();
                                }
                                else {
